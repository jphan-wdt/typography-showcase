...
export default function StickyReveal() {
  ...
  return (
    <div className={`relative h-[465vh] w-full flow-root`}>
      ...
      {sections.map((section, index) => (
        <div
          className={`sticky top-0 h-screen px-10 ${section.bgColour} border-black border-t-2 overflow-hidden`}
          key={index}
        >
          <div className="relative flex h-full w-full pt-[10vh]">
            <div
